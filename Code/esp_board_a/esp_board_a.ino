...
bool gyroscopeEnterPressed = false, tofThresholdDetected = false, maxWaterLevelReached = true, fillWaterEnterPressed = false, resetCalled = false, mixSecondStage = false, tempRunning = false;
...
void handleHashKey() {
  ...
  switch (currentState) {
    ...
    // Add more cases for additional states if needed (for further development)
    default:
      break;
  }
}
